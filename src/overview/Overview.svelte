<script>
  ...
  let imageOptions = [
    { file: "Zero.jpeg", class: "Zero" },
    { file: "One.jpeg", class: "One" },
    { file: "Two.jpeg", class: "Two" },
    { file: "Three.jpeg", class: "Three" },
    { file: "Four.jpeg", class: "Four" },
    { file: "Five.jpeg", class: "Five" },
    { file: "Six.jpeg", class: "Six" },
    { file: "Seven.jpeg", class: "Seven" },
    { file: "Eight.jpeg", class: "Eight" },
    { file: "Nine.jpeg", class: "Nine" },
  ];
  ...
  onMount(async () => {
    ...
    console.log(
      "cnn layer ranges and MinMax are: ",
      cnnLayerRanges,
      cnnLayerMinMax
    );
